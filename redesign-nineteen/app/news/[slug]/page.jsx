          ...
          <div className="glass news-detail-card">
            ...
            <div className="news-footer-bar">
              ...
              <div className="share-links">
                <a id="fb-share" href={`https://www.facebook.com/sharer/sharer.php?u=https://acutefilmmovies-v2.web.app/news/${news.slug}`} target="_blank" rel="noopener noreferrer"><i className="fab fa-facebook fa-xl"></i></a>
                <a id="tw-share" href={`https://twitter.com/intent/tweet?url=https://acutefilmmovies-v2.web.app/news/${news.slug}&text=${news.name}`} target="_blank" rel="noopener noreferrer"><i className="fas fa-retweet fa-xl"></i></a>
              </div>
            </div>
          </div>
        </div>
